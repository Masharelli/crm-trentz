        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-zinc-500">
              Registra gastos de oficina para comparar contra pagos cobrados.
            </p>
          </div>
        </div>
      </header>
          ...
          >
            ...
            <div className="space-y-5 px-6 py-6">
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  name="description"
                  placeholder="Ej. Renta oficina junio"
                  required
                  type="text"
                />
              </div>
              ...
              <div className="grid gap-5 sm:grid-cols-2">
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    className={inputClass}
                    name="vendor"
                    placeholder="Ej. WeWork, CFE, Google"
                    type="text"
                  />
                </div>
              </div>
            ...
            <div className="px-6 py-6">
              <textarea
                ...
                name="notes"
                placeholder="Referencia, folio, condiciones o detalle interno..."
              />
            </div>
