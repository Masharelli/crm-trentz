      ...
      <div className="flex-1 px-4 py-6 sm:px-6 lg:px-8">
        ...
        <section className="mt-6 grid gap-6 xl:grid-cols-[minmax(0,1.35fr)_minmax(320px,0.65fr)]">
          <div className="rounded-lg border border-zinc-200 bg-white">
            <div className="flex flex-col gap-3 border-b border-zinc-200 p-5 sm:flex-row sm:items-center sm:justify-between">
              ...
              <button
                className="inline-flex h-10 items-center justify-center gap-2 rounded-md border border-zinc-200 px-3 text-sm font-semibold text-zinc-700 transition hover:bg-zinc-50"
                type="button"
              >
                    ...
                    upcomingPayments.map((payment) => (
                      <tr key={`${payment.client}-${payment.dueDate}`}>
                        ...
                        <td className="px-5 py-4">
                          <span
                            className={`inline-flex h-7 items-center rounded-md px-2.5 text-xs font-semibold ring-1 ${payment.statusClass}`}
                          >
                            {payment.status}
                          </span>
                        </td>
        ...
        <section className="mt-6 rounded-lg border border-zinc-200 bg-white">
          <div className="flex flex-col gap-3 border-b border-zinc-200 p-5 sm:flex-row sm:items-center sm:justify-between">
            ...
            <button className="inline-flex h-10 items-center justify-center gap-2 rounded-md border border-zinc-200 px-3 text-sm font-semibold text-zinc-700 transition hover:bg-zinc-50">
              <FileUp size={17} />
              Subir archivo
            </button>
          </div>
            ...
            {documentQueue.length > 0 ? (
              documentQueue.map((document) => (
                ...
                >
                  ...
                  <button className="inline-flex h-9 items-center justify-center gap-2 rounded-md bg-zinc-100 px-3 text-sm font-semibold text-zinc-700 transition hover:bg-zinc-200">
                    Abrir
                  </button>
                </div>
              ))
